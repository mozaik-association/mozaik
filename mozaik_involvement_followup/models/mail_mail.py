...
class MailMail(models.Model):
    ...
    def _get_partner_access_link(self, mail, partner=None):
        ...
        """
        if (
            mail.model == "partner.involvement"
            and mail.res_id
        ...
        res = super(MailMail, self)._get_partner_access_link(mail, partner=partner)
        return res
    ...
    def send_get_mail_subject(self, mail, force=False, partner=None):
        ...
        if mail.model == "partner.involvement" and mail.res_id and mail.notification:
            ...
            if involvement:
                res = "%s: %s" % (mail.record_name, involvement.partner_id.display_name)
        if not res:
