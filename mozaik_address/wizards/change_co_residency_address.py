...
class ChangeCoResidencyAddress(models.TransientModel):
    ...
    address_id = fields.Many2one(
        "address.address", "New Address", required=True, ondelete="cascade"
    )
    ...
    def _use_allowed(self, co_residency_id):
        ...
        if len(sudo_res.postal_coordinate_ids) != len(
            uid_res.postal_coordinate_ids
        ):
            return False
        return True
    ...
    def change_address(self):
        ...
        if new_coord_ids:
            ...
            if res and res.get("new_co_res") and cores.line or cores.line2:
                ...
                vals = dict(line=cores.line, line2=cores.line2)
