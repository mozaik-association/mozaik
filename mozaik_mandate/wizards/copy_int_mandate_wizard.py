...
class CopyIntMandateWizard(models.TransientModel):
    ...
    mandate_id = fields.Many2one(comodel_name="int.mandate", string="Internal Mandate")
    assembly_id = fields.Many2one(
        comodel_name="int.assembly", string="Internal Assembly"
    )
    new_assembly_id = fields.Many2one(
        comodel_name="int.assembly", string="New Internal Assembly"
    )
