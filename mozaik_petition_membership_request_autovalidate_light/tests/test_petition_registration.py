...
from odoo.addons.mozaik_petition_membership_request_involvement.tests.test_petition_registration import (  # noqa: B950 pylint: disable=line-too-long
    TestPetitionRegistration as BaseTestPetitionRegistration,
)


class TestPetitionRegistration(BaseTestPetitionRegistration):
    def test_registration_no_autovalidation(self):
        """
        Membership request is still in confirm.
        """
        self.petition.auto_accept_membership = False
