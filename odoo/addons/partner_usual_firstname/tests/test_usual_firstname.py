...
class TestUsualFirstname(TransactionCase):
    ...
    def test_compute_and_sanitize(self):
        ...
        self.assertEqual('Vladinou', poutine.firstname)
        self.assertFalse(poutine.usual_firstname)
        self.assertEqual('Poutinou Vladinou', poutine.usual_name)
        # rollback to Poutine Vladimir
        poutine.name = 'Poutine Vladimir'
        self.assertEqual('Poutinou Vladimir', poutine.usual_name)
    ...
    def test_get_names(self):
        ...
        self.assertEqual(
            ['Benoît', 'Poelvoorde'], ben._get_names(reverse=True))
        self.assertEqual(
            ['Poelvoorde', 'Ben'], ben._get_names(usual=True))
        self.assertEqual(
