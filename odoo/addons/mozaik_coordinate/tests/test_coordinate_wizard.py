...
class TestCommonCoordinateWizard(TestCommonAbstractCoordinate):
    ...
    def _get_odoo_models(self):
        ...
        """
        result = super()._get_odoo_models()
        result.append(TestChangeMainCoordinate)
        return result
    ...
    def setUp(self):
        ...
        self.partner2 = self.partner_obj.create({
            'name': 'Thierry',
        })
        self.partner3 = self.partner_obj.create({
            'name': 'Jacques',
        })
        self.partner4 = self.partner_obj.create({
            'name': 'Pauline',
        })
